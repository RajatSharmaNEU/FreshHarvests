      ...
      <div className="custom_container">
        <div className="row">
          <div className="col-md-7 my-auto">
            <Fade left>
              <TextContent
                title="Connect and share shopping lists with your friends"
                desc="Find your friends, send friend requests, chat with them, share shopping lists."
              >
                <Circle num="22" />
              </TextContent>
            </Fade>
